import React, {useState, useEffect, useContext} from 'react'
 ...
 const Cart = () => {
    ...
    // Effect: Extract valid cart items from nested cart structure
      useEffect(()=>{
    ...
    <div className='border-t pt-14'>
      ...
      {/* Cart Items List */}
        {cartData.map((item, index) => {  
          const productData = products.find((product)=> product._id === item._id); //Find product details from products list

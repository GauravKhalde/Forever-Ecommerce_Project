...
const PlaceOrder = () => {
  ...
  const onSubmitHandler=async(event)=>{
    event.preventDefault();
      ...
      try{
        let orderItems = []   //store all the product fom our cart array 
        ...
        switch(method){
          //api call for cash on delivery option
          case 'cod':
            console.log("Sending orderData:", orderData); // ✅ Debug structure before sending
